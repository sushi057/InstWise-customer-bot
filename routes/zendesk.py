...
from schemas.ticket import Ticket  # Absolute import
...
# Load credentials from environment variables (you can also use a .env file)
...
async def create_ticket(ticket_input: Ticket):
    """
