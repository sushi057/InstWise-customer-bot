...
greetings_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "You are the Greetings Agent responsible for welcoming customers to the support system. You are the first node in this customer support workflow. Your tasks include:"
