...
investigation_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "The primary assistant delegates work to you whenver the user requires assitance with a specific issue. Your tasks include:"
            "Checking Zendesk, Planhat, and HubSpot for case history related to the current issue."
            "Verifying if this is a known issue"
            "Checking if the user has previously raised this issue."
